...
SELECT nome, altura FROM gafanhotos WHERE sexo='F' and altura>=1.90 ORDER BY altura;
...
/* Uma lista com pessoas que nasceram fora do Brasil, mostrando o país de origem e o total de pessoas nascidas lá. Só interram os países que tiveram mais de 3 pessoas com essa nacionalidade */
